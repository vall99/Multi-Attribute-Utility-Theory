...
if (isset($_POST['button'])) {
  mysqli_query($db, "INSERT INTO pilihan_kriteria (nama_SubKriteria, id_kriteria, nilai_SubKriteria) VALUES('$_POST[nama_SubKriteria]', '$_POST[id_kriteria]', '$_POST[nilai_SubKriteria]')");
...
<body>
  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="450" class="table-bordered" align="center" style="border-color:black">
      <thead>
        <tr>
          <th colspan="2" bgcolor=#0D6EFD style="text-align: center;"><a style="color: white;  font-size:15px;">Tambah SubKriteria</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td bgcolor="#FFFFFF">Nama Pilihan SubKriteria</td>
          <td width="218" bgcolor="#FFFFFF"><input type="text" name="nama_SubKriteria" id="nama_SubKriteria" /></td>
        </tr>
      </tbody>
      <tr>
      ...
      <tbody>
        <tr>
          ...
          <td bgcolor="#FFFFFF"><input type="text" name="nilai_SubKriteria" id="nilai_SubKriteria" /></td>
        </tr>
      </tbody>
      <tbody>
        <tr>
