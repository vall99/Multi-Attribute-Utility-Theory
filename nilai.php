...
<body>
  ...
  <br>
  <br>
  <h3 style="text-align: center;"><b>Data Nilai</b>
    <table class="table-bordered" align="center" style="border-color:black" width="900">
      <thead>
        <tr>
          ...
          <th bgcolor=#0D6EFD><a style="color: white; font-size:15px">Nilai</th>
          <th bgcolor=#0D6EFD><a href=" add-nilai.php" style="color: white; font-size:15px">Add</th>
        </tr>
      </thead>
      <tbody>
        <?php
        $querynilai = mysqli_query($db, "SELECT * FROM nilai ORDER BY id_alternatif, id_kriteria, id_SubKriteria");
        while ($datanilai = mysqli_fetch_array($querynilai)) {
          ...
          $querypilihankriteria = mysqli_query($db, "SELECT * FROM pilihan_kriteria WHERE id_SubKriteria = '$datanilai[id_SubKriteria]'");
        ...
        ?>
          <tr>
            <td align="center" style="font-size:18px"><?php echo $datanilai['id_nilai']; ?> </td>
            ...
            <td align="center" style="font-size:18px"><?php echo $datanilai['nilai']; ?></td>
            <td align="center" style="font-size:18px">
              <a href="edit-nilai.php?id_nilai=<?php echo $datanilai['id_nilai']; ?>">Edit</a> / <a href="del-nilai.php?id_nilai=<?php echo $datanilai['id_nilai']; ?>">Del</a>
            </td>
          </tr>
        <?php
        }
