...
if (isset($_POST['button'])) {
  mysqli_query($db, "UPDATE alternatif SET nama_alternatif = '$_POST[nama_alternatif]'  WHERE id_alternatif = '$_POST[id_alternatif]'");
...
<body>
  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="450" class="table-bordered" align="center" style="border-color:black">
      <thead>
        <tr>
          <th colspan="2" bgcolor=#0D6EFD style="text-align: center;"><a style="color: white;  font-size:15px;">Edit Data Alternatif</th>
        </tr>
      </thead>
      <tbody>
        <?php
