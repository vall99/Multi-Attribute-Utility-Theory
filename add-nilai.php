...
if (isset($_POST['button'])) {
  ...
  mysqli_query($db, "INSERT INTO nilai(id_alternatif, id_SubKriteria, id_kriteria, nilai) VALUES('$_POST[id_alternatif]', '$_POST[id_SubKriteria]', '$datapilihankriteria[id_kriteria]', '$datapilihankriteria[nilai_SubKriteria]')");
...
<body>
  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="775" class="table-bordered" align="center" style="border-color:black">
      <thead>
        <tr>
          <th colspan="2" bgcolor=#0D6EFD style="text-align: center;"><a style="color: white;  font-size:15px;">Tambah Nilai</th>
        </tr>
      </thead>
      <tbody>
        <tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><select name="id_SubKriteria" id="id_SubKriteria">
            <option value=""></option>
            <?php
            ...
            while ($datapilihankriteria = mysqli_fetch_array($querypilihankriteria)) {
              ...
              $datakriteria = mysqli_fetch_array($querykriteria);
            ?>
              <option value="<?php echo $datapilihankriteria['id_SubKriteria']; ?>"><?php echo $datakriteria['nama_kriteria']; ?> - <?php echo $datapilihankriteria['nama_SubKriteria']; ?> - Nilai: <?php echo $datapilihankriteria['nilai_SubKriteria']; ?></option>
            <?php
            }
            ?>
          </select></td>
