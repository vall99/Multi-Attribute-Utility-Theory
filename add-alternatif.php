...
if (isset($_POST['button'])) {
  mysqli_query($db, "INSERT INTO alternatif(nama_alternatif) VALUES('$_POST[nama_alternatif]')");
...
<body>
  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="450" class="table-bordered" align="center" style="border-color:black">
      <thead>
        <tr>
          <th colspan="2" bgcolor=#0D6EFD style="text-align: center;"><a style="color: white;  font-size:15px;">Tambah Alternatif</th>
        </tr>
      </thead>
      <tbody>
        <tr>
